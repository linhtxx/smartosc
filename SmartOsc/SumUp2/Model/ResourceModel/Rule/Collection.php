...
namespace SmartOsc\SumUp2\Model\ResourceModel\Rule;
...
class Collection extends AbstractCollection
{
     ...
     * @param Json|null $serializer Optional parameter for backward compatibility
     */
    ...
    {
        $this->_init(Rule::class, \Magento\SalesRule\Model\ResourceModel\Rule::class);
     ...
     * @param Address|null $address allow extensions to further filter out rules based on quote address
     * @return $this
