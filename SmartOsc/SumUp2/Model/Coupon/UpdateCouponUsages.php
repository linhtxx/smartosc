...
namespace SmartOsc\SumUp2\Model\Coupon;
 ...
 */
class UpdateCouponUsages extends Coupon\UpdateCouponUsages
{
    /**
     * @var RuleFactory
     */
    ...
    {
        $arrayCoupon = explode(",", $subject->getCouponCode());
        foreach($arrayCoupon as $coupon) {
